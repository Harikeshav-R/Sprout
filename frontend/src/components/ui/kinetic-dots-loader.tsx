...
export default function KineticDotsLoader() {
    ...
    return (
        <div className='flex items-center justify-center min-h-[150px] p-4 bg-transparent'>
            <div className='flex gap-5'>
                {[...Array(dots)].map((_, i) => (
                    ...
                    >
                        ...
                        >
                            <div
                                className='w-full h-full rounded-full bg-gradient-to-b from-sprout-sage to-sprout-green shadow-[0_0_15px_rgba(14,58,42,0.6)]'
                                style={{
                        ...
                        <div
                            className='absolute bottom-0 w-10 h-3 border border-sprout-green/30 rounded-[100%] opacity-0'
                            style={{
                        ...
                        {/* 3. REFLECTIVE SHADOW */}
                        <div
                            className='absolute -bottom-1 w-5 h-1.5 rounded-[100%] bg-sprout-green/40 blur-sm'
                            style={{
